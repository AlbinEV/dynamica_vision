...
int main(int argc, char ** argv)
{
  ...
  auto image_sub = node->create_subscription<sensor_msgs::msg::Image>("/robot/camera_2/depth/image_rect_raw", 10, depthCb);
  auto rgb_image_sub = node->create_subscription<sensor_msgs::msg::Image>("/robot/camera_2/color/image_raw", 10, rgbCb);
  cam_info_sub = node->create_subscription<sensor_msgs::msg::CameraInfo>("/robot/camera_2/depth/camera_info", 10, infoCb);

  g_pub_point_cloud = node->create_publisher<sensor_msgs::msg::PointCloud2>("/robot/camera_2/point_cloud", 10);
